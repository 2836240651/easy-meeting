...
public interface UserContactService {
    ...
    UserInfoVo4Search searchContact(String userId, String email, String myuserId);

    void delContact(@NotEmpty String userId, @NotEmpty String contactId, @NotNull Integer status);

    /**
     * 取消拉黑
     */
    void unblackContact(@NotEmpty String userId, @NotEmpty String contactId);
}