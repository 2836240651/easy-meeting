...
public interface MeetingChatMessageService {
    ...
    void saveMessage(MeetingChatMessage meetingChatMessage);

	void uploadFile(TokenUserInfoDto tokenUserInfo,  MultipartFile file,  Long messageId,  Long sendTime)throws IOException;
}